    ...
    switch(e.which){
        ...
        case 13:
            ...
            if(checkCrush(fixed, tetriMino.getMino(positionx, positiony))) {
                if(!checkCrush(fixed, tetriMino.getMino(positionx+1, positiony))){
                ...
                if(!checkCrush(fixed, tetriMino.getMino(positionx+2, positiony))){
                ...
                if(!checkCrush(fixed, tetriMino.getMino(positionx, positiony-2))){
